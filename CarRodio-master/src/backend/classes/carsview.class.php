...
EOT;
            ...
            echo <<<EOT
                                ...
                                <figcaption class="info-wrap">
                                    ...
                                    <a href="./chatpage.php" class="btn btn-block btn-primary">Enquire Seller </a>
                                </figcaption>
                            </figure>
                        </div> <!-- col.// -->
...
EOT;
    ...
    public function showFavCarsforAds($ID)
    {
        $results = $this->getCar($ID);
        foreach ($results as $name) {
            $carDetailsID = $name['CarDetails'];
...
EOT;
            ...
            echo <<<EOT
                                ...
                                <figcaption class="info-wrap">
                                    ...
                                    <a href="./deletefav.php" class="btn btn-block btn-danger">Delete From Favourties </a>
                                </figcaption>
                            </figure>
                        </div> <!-- col.// -->
